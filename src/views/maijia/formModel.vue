				...
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="卖家密码" prop="maijiamima">
							<el-input class="list_inp" v-model="form.maijiamima" placeholder="卖家密码"
								type="password" :readonly="!isAdd||disabledForm.maijiamima?true:false" />
						</el-form-item>
					</el-col>
					<el-col :span="24">
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='maijiamima'){
					form.value.maijiamima = row[x];
					disabledForm.value.maijiamima = true;
					continue;
				}
				if(x=='maijiaxingming'){
