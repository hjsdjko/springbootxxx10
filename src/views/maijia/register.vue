	...
	<div>
		<div class="register_view">
			<el-form :model="registerForm" class="register_form">
				...
				<div class="list_item">
					<div class="list_label">卖家账号：</div>
					<el-input class="list_inp"
						 v-model="registerForm.maijiazhanghao" 
						 placeholder="请输入卖家账号"
						 type="text"
						/>
				</div>
				<div class="list_item">
					<div class="list_label">卖家密码：</div>
					<el-input class="list_inp"
						 v-model="registerForm.maijiamima" 
						 placeholder="请输入卖家密码"
						 type="password"
						 />
				</div>
				<div class="list_item">
					<div class="list_label">确认卖家密码：</div>
					<el-input class="list_inp" v-model="registerForm.maijiamima2" type="password" placeholder="请输入确认卖家密码" />
				</div>
				<div class="list_item">
					<div class="list_label">卖家姓名：</div>
					<el-input class="list_inp"
						 v-model="registerForm.maijiaxingming" 
						 placeholder="请输入卖家姓名"
						 type="text"
						/>
				</div>
...
<script setup>
	...
	const handleRegister = () => {
		...
		if((!registerForm.value.maijiazhanghao)){
			context?.$toolUtil.message(`卖家账号不能为空`,'error')
			return false
		}
		if((!registerForm.value.maijiamima)){
			context?.$toolUtil.message(`卖家密码不能为空`,'error')
			return false
		}
		if(registerForm.value.maijiamima!=registerForm.value.maijiamima2){
			context?.$toolUtil.message('两次密码输入不一致','error')
			return false
		}
		if((!registerForm.value.maijiaxingming)){
